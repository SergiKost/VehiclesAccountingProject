    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Petrols", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Engines_Petrols_PetrolTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriveLicenseNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistPlate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReleaseYear = table.Column<int>(type: "int", nullable: false),
                    StockMass = table.Column<int>(type: "int", nullable: false),
                    MaxMass = table.Column<int>(type: "int", nullable: false),
                    EngineId = table.Column<int>(type: "int", nullable: true),
                    ChassisNumber = table.Column<int>(type: "int", nullable: false),
                    HullNumber = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "SystemRoles",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "Глава отдела" });

            migrationBuilder.InsertData(
                table: "SystemRoles",
                columns: new[] { "Id", "Name" },
                values: new object[] { 3, "Специалист" });
